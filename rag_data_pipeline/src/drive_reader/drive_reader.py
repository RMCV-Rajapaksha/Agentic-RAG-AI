"""
Functional module for loading documents from Google Drive using LlamaIndex's GoogleDriveReader.
"""
...
def preview_document(documents, index: int = 0):
    ...
    Args:
        documents (list): List of documents returned by load_google_drive_documents().
